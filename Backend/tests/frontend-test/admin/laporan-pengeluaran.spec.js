...
test('Admin Berhasil Tambah Pengeluaran Lengkap dan Verifikasi', async ({ page }) => {
  ...
  // 3. Navigasi ke Laporan Pengeluaran
  console.log('Membuka Laporan Pengeluaran...');
  await page.click('#laporan-btn'); 
  await page.waitForTimeout(1000);
  await page.click('text=Keuangan Pengeluaran');
  ...
  // Gunakan state 'attached' (elemen ada di DOM) sebagai pengganti 'visible'
  ...
  const namaKeterangan = "Pembelian Spidol Project Jingga"; 
